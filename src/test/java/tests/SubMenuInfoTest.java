...
public class SubMenuInfoTest extends BaseTest {
    ...
    public void testLabelTextSubmenuInfo(){
        final String expectedSubmenuInfoLabel = "History";

        openBaseURL();
        InfoSubmenuPage infoSubmenuPage = new InfoSubmenuPage(getDriver());

        String actualSubmenuInfoLabel = infoSubmenuPage.getInfoSubMenuLabelText();

        Assert.assertEquals(actualSubmenuInfoLabel, expectedSubmenuInfoLabel);
    }
