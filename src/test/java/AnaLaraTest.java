...
public class AnaLaraTest extends BaseTest {
    ...
    final static By LANGUAGES_NAME_LIST = By.xpath("//table[@id = 'category']/tbody/tr/td[1]/a");
    ...
    private List<String> getElementsText(By by, WebDriver driver) {
        ...
        public void testSearchLanguageField_HappyPath () {
            ...
            List<WebElement> languagesNameList = getListOfElements(LANGUAGES_NAME_LIST, getDriver());

            List<String> languageNames = getElementsText(LANGUAGES_NAME_LIST, getDriver());
